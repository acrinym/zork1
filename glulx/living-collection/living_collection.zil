...
<SYNTAX ASK OBJECT (FIND ACTORBIT) TO FILE = V-LC-ASK-FILE>
<SYNTAX ASK OBJECT (FIND ACTORBIT) TO PREPARE = V-LC-ASK-PREPARE>
<SYNTAX ASK OBJECT (FIND ACTORBIT) TO REST = V-LC-ASK-REST>
<SYNTAX ASK OBJECT (FIND ACTORBIT) TO SLEEP = V-LC-ASK-REST>
