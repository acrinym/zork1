<ROUTINE MARA-PLAYER-FOLLOW ()
    ...
    <COND (<ZERO? <MARA-GET ,MARA-SLOT-DAM-SURVEY>>
          ...
          (<MARA-GET ,MARA-SLOT-HOUSE-STAY>
           <TELL "Mara glances toward the route back to the House, then at you. The Attic is a base, not a leash, she says. Choose the expedition; ask me to follow if our routes overlap." CR>)
          (T
...
<ROUTINE MARA-FIELD-PACK-FCN ()
    ...
    <COND (<VERB? EXAMINE>
           ...
           <COND (<IN? ,MARA-FIELD-PACK ,MARA>
                  <TELL " Mara is carrying it herself.">)
                 (<EQUAL? <LOC ,MARA-FIELD-PACK> ,ATTIC>
                  <TELL " It rests where Mara chose to base herself in the Attic.">)>
...
<ROUTINE MARA-FCN ()
    ...
    <COND (<AND <EQUAL? ,WINNER ,MARA> <VERB? FOLLOW>>
          ...
          (<AND <EQUAL? ,WINNER ,MARA> <VERB? MARA-BRACE>>
           <V-MARA-BRACE>)
          (<AND <EQUAL? ,WINNER ,MARA> <VERB? TAKE>
                <EQUAL? ,PRSO ,MARA-FIELD-PACK>>
           <MARA-PACK-CAMP>)
          ...
          (<VERB? EXAMINE>
           ...
           <COND (<IN? ,MARA-FIELD-PACK ,MARA>
                  <TELL " Her waxed field pack is on her own shoulder.">)
                 (<MARA-GET ,MARA-SLOT-HOUSE-STAY>
                  <TELL " Her field pack remains in the Attic where she chose to set it down.">)>
          ...
          (<VERB? KISS>
           <COND (<MARA-GET ,MARA-SLOT-MEAL-SHARED>
                  <TELL "Mara's expression warms, but she does not meet you halfway. A shared base and a shared meal are history, she says, not permission to skip the history that has not happened yet." CR>)
                 (<MARA-GET ,MARA-SLOT-HOUSE-STAY>
                  <TELL "Mara looks toward the stair to the Attic, then back at you. Letting my pack live here was a choice about shelter, she says. Do not turn it into a claim on me." CR>)
