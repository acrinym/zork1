"ZORK1 MUSEUM INTAKE AND FIRST GALLERY GLULX for
  Zork I: The Great Underground Empire
  (c) Copyright 1983 Infocom, Inc. All Rights Reserved."

;"Repository-local post-House gameplay train. Release 1233 retains every
  qualified Release 1232 behavior and adds physical intake into the existing
  Living Room museum without duplicating objects or collection state."

<VERSION ZIP>

<SETG ZORK-NUMBER 1>

<CONSTANT RELEASEID 1233>
...
<PRINC "Museum Intake and First Gallery Glulx ZORK I: The Great Underground Empire
 ">
