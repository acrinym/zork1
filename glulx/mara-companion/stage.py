#!/usr/bin/env python3
"""Stage Mara Arrival and Evidence Memory over qualified Release 1233."""
...
def validate_base_manifest(
    ...
    """Resolve and validate the exact Release 1233 base contract."""
...
def main() -> int:
    """Stage the exact two-path Mara delta and write a receipt."""
    ...
    base_destination = destination.parent / f"base-museum-intake-src-{uuid.uuid4().hex}"
    ...
    print(
        f"Staged Mara Arrival Release {manifest.get('release')} over "
...
if __name__ == "__main__":
    try:
        ...
        print(f"stage_mara_companion: {exc}", file=sys.stderr)
