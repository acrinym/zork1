...
>
> **Merged production on `master`:** through Release **1296** leaflet-hour noun honesty ([PR #92](https://github.com/acrinym/zork1/pull/92) merge `9be10c1`), which still includes Living Collection **1304** and runtime **1280–1286**. **Open CURRENT:** Releases **1301–1303** survey flags, census, and empire noun honesty. Law: [`docs/planning/DESCRIBED_WORLD_IS_LAW_2026-08-30.md`](docs/planning/DESCRIBED_WORLD_IS_LAW_2026-08-30.md). Census: [`docs/planning/DESCRIBED_WORLD_CENSUS_1302.md`](docs/planning/DESCRIBED_WORLD_CENSUS_1302.md).
>
