# Flathead Fair games, competitions, and records
...
**Operator:** Jonas Pell  
**Price:** 2 zm per standard attempt  
**Primary mechanic:** aim/choice + learnable equipment behavior  
**Chance:** low/bounded
...
**Price:** 2 zm  
**Primary mechanic:** force/technique and existing physical condition where authority supports it  
**Chance:** none or negligible
...
**Price:** 3 zm  
**Primary mechanic:** deterministic target cycle + observation/timing  
**Chance:** none after cycle state is set

Mechanical targets appear/move in a known repeating authored pattern. The player can watch before paying/acting and learn the pattern.

This is parser timing, not reflex UI. Waiting/observing changes the cycle state; choosing the right target at the right phase matters.

No real firearm system is introduced for the fair. The gallery uses a self-contained fair mechanism appropriate to final Zork-world design.

**Tickets:** score bands such as 2 / 5 / 8, with a persistent daily high score where appropriate.
...
**Price:** 2 zm  
**Primary mechanic:** observation and memory  
**Chance:** authored selection from a bounded object set
...
**Price:** 1 zm  
**Primary mechanic:** observation of an authored move sequence  
**Chance:** low if honest, higher if later operated by a dubious NPC  
**Initial status:** not run by Jonas

This game is reserved as one natural place for the future suspicious-operator story.

Important distinction:

- an honest version can be beaten through observation;
...
**Price:** watching is free; wagers/entries depend on final money/gambling boundary  
**Primary mechanic:** day-seeded competitor form + bounded race uncertainty
...
## Mechanic diversity matrix

| Game | Main skill | RNG role | Learnable? | Persistent record? |
|---|---|---|---|---|
| Ring Stand | target choice / throw behavior | low | yes | clean sweep |
| Bottle Knockdown | setup reading / placement | low | yes | efficient clear |
| Bell Striker | technique / physical state | negligible | partly | best result |
| Target Gallery | cycle observation | none after state | yes | score |
| Horseshoes | skill + uncertainty | medium | partly | match/score |
| What's Missing | observation/memory | choice of puzzle only | yes | perfect set |
| Shell Game | observation / investigation | varies by operator | yes | usually no |
| Critter Race | inference + chance | meaningful | tendencies yes | race history |

## Ticket economy

Tickets reward variety more than repetition.

### Standard award philosophy

- failed ordinary attempt: usually 0;
- modest success: 1–2;
- solid success: 3–5;
- exceptional result: 6–8;
- record/featured contest: ribbon, trophy, direct prize or one-time bonus rather than endlessly multiplied tickets.

### Diminishing-repeat law
...
A rigged game is valid **content** only if:

1. the game has observable physical rules;
2. something specifically violates those rules;
...
- No GUI reflex games.
- No universal skill-stat screen invented for the fair.
