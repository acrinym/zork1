...
### 4. The old compiler report lists unused symbols, but deletion is not yet justified
...
### 5. The clock scheduler has a fixed implicit capacity
...
### 6. Global state and magic values are pervasive by design
...
### 7. Exact transcript comparison is unsafe for every route
...
The next safe step is to get this pipeline running under ZILF/ZAPF and capture baseline command transcripts before touching gameplay logic.
