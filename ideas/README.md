...
This directory preserves substantial future ideas without mixing them into the active House of Records implementation train.

These are **concept lanes**, not hidden sub-beads, not an alternate Kanban, and not claims that implementation has begun. An idea may later be promoted into a real product train only when its scope, dependencies, and place in the release lineage are deliberately chosen.
...
- Do not create sub-beads under existing beads to absorb these ideas.
...
The House of Records work has demonstrated that a classic parser world can support persistent evidence, provenance, physical records, visitors, dreams, event playback, damage, repair, and save/restore continuity. Those discoveries naturally produce ideas larger than the current House train.

This directory gives those ideas a truthful home without derailing the work already underway.